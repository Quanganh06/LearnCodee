...
import thi.Service.SanPhamNhapKhauService.ISanPhamNhapKhauService;
import thi.Service.SanPhamNhapKhauService.SanPhamNhapKhauService;
            ...
            switch (chon){
                    ...
                    do {
                        ...
                        switch (luachon1){
                            case 1:
                                ...
                                iSanPhamNhapKhauService.xoa(id);
                                System.out.println("----------------------");
                ...
                case 3:
                    ...
                    do {
                        ...
                        switch (luachon2){
                            case 1:
                               iSanPhamNhapKhauService.danhSach();
                                break;
                            case 2:
                                break;
                            case 3:
                    ...
                    do {
                        ...
                        switch (luachon3){
                            case 1:
                                System.out.println("Nhập vào id: ");
                                int id = Integer.parseInt(scanner.nextLine());
                                iSanPhamNhapKhauService.timKiemID(id);
                                break;
                            case 2:
                                System.out.println("Nhập vào tên sản phẩm : ");
                                String name = scanner.nextLine();
                                iSanPhamNhapKhauService.tinKiemTen(name);
                                break;
                            case 3:
                                break;
                        }
